...
function RecruitInfo() {
  return (
    <section className={'p-recruit-recruit-info__recruitInfo'} id='recruit-info'>
        <div className={'p-recruit-recruit-info__container'}>
            <div className={'p-recruit-recruit-info__titleArea'}>
                <h2 className={'p-recruit-recruit-info__title c-title3-bold'}>
                    <span className={'p-recruit-recruit-info__titleEn c-title3-bold-en blue'}>Recruit Info</span>
                    <span className={'p-recruit-recruit-info__titleJa c-title3-bold-ja bk'}>募集要項</span>
                </h2>
            </div>
            <div className={'p-recruit-recruit-info__content'}>
                <table className={'p-recruit-recruit-info__table'}>
                    {
                        data.map((item, index) => (
                            <tr key={index} className={'p-recruit-recruit-info__tr'}>
                                <th className={'p-recruit-recruit-info__th c-about-recruit-info-title'}>{item.title}</th>
                                <td className={'p-recruit-recruit-info__td c-about-recruit-info-text'}>{item.text}</td>
                            </tr>
                        ))
                    }
                    <tr className={'p-recruit-recruit-info__tr'}>
                        ...
                        <td className={'p-recruit-recruit-info__td c-about-recruit-info-text'}>
                            ...
                            <p className={'p-recruit-recruit-info__caption'}>※研修時の交通費も全額支給します！</p>
                            <p className={'p-recruit-recruit-info__caption'}>※希望者には美味しいまかない付き！(一食400円)</p>
                        </td>
                    </tr>
                    <tr className={'p-recruit-recruit-info__tr'}>
                        <th className={'p-recruit-recruit-info__th c-about-recruit-info-title'}>面接</th>
                        <td className={'p-recruit-recruit-info__td c-about-recruit-info-text'}>
            ...
            <Link className={'p-recruit-recruit-info__btn c-btn'} href="tel:03-5697-9333">
                <span className={'p-recruit-recruit-info__btn__text c-btn-text wh'}>相談する</span>
